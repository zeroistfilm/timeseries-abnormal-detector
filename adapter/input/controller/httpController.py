...
#     try:
#         # 각 센서에 대해 데이터 생성
#         sensor_ids = ['humidity/최율농장/2/1-1']  # 예시 센서 ID들
...
#                 metadata=sensor_data.metadata  # Pass metadata from generated sensor data
#             )
#
...
async def get_abnormal_data():
    ...
    return {"abnormal_devices": sensor_service.get_abnormal_data()}
...
async def get_abnormal_data(sensor_id: str):
    ...
    abnormal_data = sensor_service.get_abnormal_data_by_id(sensor_id)
